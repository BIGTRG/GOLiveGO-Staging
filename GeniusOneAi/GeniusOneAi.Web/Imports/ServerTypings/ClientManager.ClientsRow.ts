namespace GeniusOneAi.ClientManager {
    ...
    export namespace ClientsRow {
        ...
        export const localTextPrefix = 'ClientManager.Clients';
        export const lookupKey = 'GeniusOneAi.Clients';

        export function getLookup(): Q.Lookup<ClientsRow> {
            return Q.getLookup<ClientsRow>('GeniusOneAi.Clients');
        }
