...
namespace GeniusOneAi.Workflows.Entities
{
    ...
    [ConnectionKey("Default"), Module("Workflows"), TableName("[dbo].[WorkerInvoices]")]
    [DisplayName("Invoices"), InstanceName("Invoices")]
    [ReadPermission(PermissionKeys.ContractorInvoices)]
    [ModifyPermission(PermissionKeys.ContractorInvoices)]
    public sealed class InvoicesRow : Row<InvoicesRow.RowFields>, IIdRow, INameRow
    {
       [DisplayName("User Invoice Id"), Identity, IdProperty]
        ...
        [DisplayName("Status"), Size(25)][InvoiceStatusEditor]
