...
namespace GeniusOneAi.Workflows.Entities
{
    ...
    using System.IO;
    using GeniusOneAi.WorkerPortal.Workflows;

    [ConnectionKey("Default"), Module("Workflows"), TableName("[dbo].[Activities]")]
    [DisplayName("Activities"), InstanceName("Activities")]
    [ReadPermission(PermissionKeys.NotesReview)]
    [ModifyPermission(PermissionKeys.NotesReview)]
    public sealed class WorkerActivitiesRow : Row<WorkerActivitiesRow.RowFields>, IIdRow, INameRow
    {
       [DisplayName("Activity Id"), Identity, IdProperty]
        ...
        [DisplayName("Invoice Id"), Size(25)]
        ...
        public WorkerActivitiesRow()
        {
        }

        public WorkerActivitiesRow(RowFields fields)
            : base(fields)
        {
        }
