...
namespace GeniusOneAi.Workflows.Entities
{
    ...
    [DisplayName("BillingActivities"), InstanceName("BillingActivities")]
    [ReadPermission(PermissionKeys.Billing)]
    [ModifyPermission(PermissionKeys.Billing)]
    public sealed class BillingActivitiesRow : Row<BillingActivitiesRow.RowFields>, IIdRow, INameRow
    {
       [DisplayName("Activity Id"), Identity, IdProperty]
        ...
        public BillingActivitiesRow()
        {
        }

        public BillingActivitiesRow(RowFields fields)
            : base(fields)
        {
        }
