...
namespace GeniusOneAi.WorkerPortal.Entities
{
    ...
    [DisplayName("Activities Log"), InstanceName("Worker Activities Log")]
    [ReadPermission(Workflows.PermissionKeys.NotesReview)]
    [ModifyPermission(Workflows.PermissionKeys.NotesReview)]
    public sealed class WorkerActivitiesLogRow : Row<WorkerActivitiesLogRow.RowFields>, IIdRow, INameRow
    {
       [DisplayName("Activities Log Id"), PrimaryKey, IdProperty]
        ...
        public WorkerActivitiesLogRow()
        {
        }

        public WorkerActivitiesLogRow(RowFields fields)
            : base(fields)
        {
        }
