...
{
    [ConnectionKey("Default"), Module("Dashboards"), TableName("[dbo].[vGlobalAgencyDashboard]")]
    [DisplayName("Global Agency Dashboard"), InstanceName("Global Agency Dashboard")]
    [ReadPermission(PermissionKeys.MainAgency)]
    [ModifyPermission(PermissionKeys.MainAgency)]
    public sealed class GlobalAgencyDashboardRow : Row<GlobalAgencyDashboardRow.RowFields>, IIdRow
    {
        [DisplayName("Tenant Id"), NotNull, IdProperty]
        public int? TenantId
        {
        ...
        [DisplayName("Credentials Expiring This Month"), NotNull]
        ...
        public GlobalAgencyDashboardRow()
            : base()
        {
        }

        public GlobalAgencyDashboardRow(RowFields fields)
            : base(fields)
        {
        }
