    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your GeniusOneAi Password";
                ...
                {
                    public static LocalText LoginVersion = "v2.08";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your GeniusOneAi Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "GeniusOneAi App Suite";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = "Copyright (c) 2015 - 2026.";
