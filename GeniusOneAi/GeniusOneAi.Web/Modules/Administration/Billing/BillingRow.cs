...
namespace GeniusOneAi.Administration.Entities
{
    ...
    [ConnectionKey("Default"), Module("Administration"), TableName("[dbo].[Activities]")]
    [DisplayName("Administration"), InstanceName("Billing")]
    ...
    public sealed class BillingRow : Row<BillingRow.RowFields>, IIdRow, INameRow
    {
       [DisplayName("Activity Id"), Identity, IdProperty]
        ...
        public BillingRow(RowFields fields)
            : base(fields)
        {
        }
