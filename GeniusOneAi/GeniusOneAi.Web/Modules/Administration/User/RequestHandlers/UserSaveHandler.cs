...
using System.Data;
using MyRequest = Serenity.Services.SaveRequest<GeniusOneAi.Administration.UserRow>;
using MyResponse = Serenity.Services.SaveResponse;
using MyRow = GeniusOneAi.Administration.UserRow;
...
namespace GeniusOneAi.Administration
{
    ...
    public class UserSaveHandler : SaveRequestHandler<MyRow, MyRequest, MyResponse>, IUserSaveHandler
    {
        ...
        protected override void GetEditableFields(HashSet<Field> editable)
        {
            ...
            if (!Permissions.HasPermission(GeniusOneAi.AgencyAdministration.PermissionKeys.UserManagement))
            {
