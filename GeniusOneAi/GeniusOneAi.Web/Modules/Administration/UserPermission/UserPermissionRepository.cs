...
using GeniusOneAi.Web.Modules.Administration.Role;
...
using MyRow = GeniusOneAi.Administration.UserPermissionRow;
    ...
    public class UserPermissionRepository : BaseRepository
    {
            ...
            ITypeSource typeSource, bool includeRoles = false)
        {
                ...
                (includeRoles ? "IR" : "XR"), TimeSpan.Zero, RoleRow.Fields.GenerationKey, () =>
            {
                ...
                //Begin custom code Malik Brown
                result.Remove("Administration:Security");
                result.Remove("Administration:Translation");
                result.Remove("Administration:View");
                result.Remove("Administration:Modify");
                //End custom code Malik Brown
