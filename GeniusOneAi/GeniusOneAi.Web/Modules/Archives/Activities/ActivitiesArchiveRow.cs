...
namespace GeniusOneAi.Archives.Entities
{
    ...
    [ConnectionKey("Default"), Module("Archive"), TableName("[dbo].[Activities]")]
    [DisplayName("Activities"), InstanceName("ActivitiesArchive")]
    [ReadPermission(Archives.PermissionKeys.Activities)]
    [ModifyPermission(Archives.PermissionKeys.Activities)]
