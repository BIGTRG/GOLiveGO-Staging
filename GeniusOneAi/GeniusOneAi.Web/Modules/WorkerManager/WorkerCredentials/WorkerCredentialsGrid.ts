...
namespace GeniusOneAi.WorkerManager {
    ...
    export class WorkerCredentialsGrid extends Serenity.EntityGrid<WorkerCredentialsRow, any> {
        protected getColumnsKey() { return 'WorkerManager.WorkerCredentials'; }
        protected getDialogType() { return WorkerCredentialsDialog; }
        ...
        protected getColumns() {
            ...
            columns.splice(0, 0, {
                field: 'Edit Credential',
                name: '',
                format: ctx => '<a class="inline-action edit-row" title="Edit Credential"><i class="fa fa-pencil text-blue"></i></a>',
                width: 24,
                minWidth: 24,
                maxWidth: 24
            });
        ...
        protected getAddButtonCaption(): string { return "Add Credential"; }
        ...
        protected onClick(e: JQueryEventObject, row: number, cell: number) {
            ...
            if (target.hasClass('inline-action')) {
                ...
                if (target.hasClass('edit-row')) {
                    ...
                    slf.editItem(item.UserCredentialId);
                }
