...
namespace GeniusOneAi.AgencyAdministration {
    ...
    export class ProgramTypesGrid extends Serenity.EntityGrid<ProgramTypesRow, any> {
        protected getColumnsKey() { return 'AgencyAdministration.ProgramTypes'; }
        protected getDialogType() { return ProgramTypesDialog; }
        ...
        protected getInitialTitle() { return "Program Type Codelist"; }
        ...
        protected onClick(e: JQueryEventObject, row: number, cell: number) {
            ...
            if (target.hasClass('inline-action')) {
                ...
                if (target.hasClass('edit-row')) {
                    ...
                    slf.editItem(item.ProgramTypeId);
                }
                if (target.hasClass('delete-row')) {
                    ...
                    Q.confirm(
                        ...
                        () => {
                            WorkerTypesService.Delete({ EntityId: item.ProgramTypeId },
                                response => {
        ...
        protected getQuickFilters() {
            ...
            let fld = ProgramTypesRow.Fields;
