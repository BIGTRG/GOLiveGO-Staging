namespace GeniusOneAi.WorkerPortal
{
    ...
    export class MyClientAuthorizationsGrid extends Serenity.EntityGrid<ClientAuthorizationsRow, any> {
        protected getColumnsKey() { return 'WorkerPortal.ClientAuthorizations'; }
        protected getDialogType() { return MyClientAuthorizationsDialog; }
