...
namespace GeniusOneAi.WorkerPortal
{
    ...
    export class MyClientGoalsGrid extends Serenity.EntityGrid<ClientGoalsRow, any> {
        protected getColumnsKey() { return 'WorkerPortal.MyClientGoals'; }
        protected getDialogType() { return MyClientGoalsDialog; }
