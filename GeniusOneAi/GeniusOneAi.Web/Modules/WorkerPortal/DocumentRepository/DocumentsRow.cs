namespace GeniusOneAi.WorkerPortal.Entities
{
    ...
    [ConnectionKey("Default"), Module("WorkerPortal"), TableName("[dbo].[Documents]")]
    [DisplayName("Documents"), InstanceName("Documents")]
    [ReadPermission(PermissionKeys.DocumentRepository)]
    [ModifyPermission(PermissionKeys.DocumentRepository)]
    public sealed class DocumentsRow : Row<DocumentsRow.RowFields>, IIdRow, INameRow
    {
       [DisplayName("Document Id"), Identity, IdProperty]
        ...
        public DocumentsRow(RowFields fields)
            : base(fields)
        {
        }
