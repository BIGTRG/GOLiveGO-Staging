...
namespace GeniusOneAi.WorkerPortal.Columns
{
    ...
    [ColumnsScript("WorkerPortal.DocumentRepository")]
    [BasedOnRow(typeof(Entities.DocumentsRow), CheckNames = true)]
    public class DocumentRepositoryColumns
    {
        [DisplayName("Document")]
        [UrlFormatter(DisplayFormat = "View Document", UrlFormat = "javascript:loadDocViewer(1,'{0}');")]
        [Width(200)]
